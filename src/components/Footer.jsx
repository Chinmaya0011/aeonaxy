...
import { FaApple, FaAndroid, FaTwitter, FaFacebook, FaInstagram, FaLinkedin, FaYoutube } from 'react-icons/fa';
...
const Footer = () => {
    ...
    <div className='flex justify-between h-auto p-8 w-full flex-col lg:flex-row m-2'>
      ...
      <div className='section1'>
        <div className='w-3/4 '>
          ...
          <p className='mb-10 w-3/4'>We take the work out of connecting with others so you can accomplish more.</p>

          <select name="language" id="language" className="p-2 w-full mt-2 mb-10 border-b-2 border-black">
  ...
  <button className="flex items-center bg-blue-500 text-white px-2 py-1 rounded mr-2">
    <FaApple size={24} className="mr-1" /> {/* Adjust the size here */}
  ...
  <button className="flex items-center bg-green-500 text-white px-2 py-1 rounded">
    <FaAndroid size={24} className="mr-1" /> {/* Adjust the size here */}
    <div className='flex flex-col'>
...
// import { faApple, faAndroid, faTwitter, faFacebook, faInstagram, faLinkedin, faYoutube } from '@fortawesome/free-brands-svg-icons';
